Feature: Unlike Testing từ Excel - Sheet unlike
  ...
  Scenario: Chạy tất cả test cases unlike từ Excel
    ...
    * def successRate = Math.round((passedTests.length / totalTests) * 100 * 100) / 100
    
    * print '========================================='
    * print '📊 UNLIKE API - KẾT QUẢ TỔNG QUAN:'
    * print '📋 Tổng số test cases: ' + totalTests
    * print '✅ Số test PASSED: ' + passedTests.length
    * print '❌ Số test FAILED: ' + failedTests.length  
    * print '📈 Tỷ lệ thành công: ' + successRate + '%'
    * print '========================================='
    ...
    * if (writeSuccess) karate.log('Đã ghi kết quả unlike vào Excel thành công!')
    * if (!writeSuccess) karate.log('Lỗi khi ghi kết quả unlike vào Excel!') 